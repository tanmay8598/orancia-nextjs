    ...
    <div class="w-full bg-gray-50  md:mx-auto ">
      <div class="my-2 mx-auto max-w-screen-md px-10 py-16">
        <div class="flex w-full flex-col">
          <div class="flex flex-col sm:flex-row">
            <h1 class="max-w-sm text-xl font-bold ">Customer Reviews</h1>
            <div class="my-4 rounded-xl bg-white py-2 px-4 shadow sm:my-0 sm:ml-auto">
              <div class="flex h-16 items-center text-2xl font-bold ">
                <svg
            ...
            <ul class="mb-6 mt-2 space-y-2">
              <li class="flex items-center text-sm font-medium">
                ...
                <div class="mr-4 h-2 w-96 overflow-hidden rounded-full bg-gray-300">
                  <div class="h-full w-10/12 bg-primary"></div>
                </div>
              ...
              <li class="flex items-center text-sm font-medium">
                ...
                <div class="mr-4 h-2 w-96 overflow-hidden rounded-full bg-gray-300">
                  <div class="h-full w-8/12 bg-primary"></div>
                </div>
              ...
              <li class="flex items-center text-sm font-medium">
                ...
                <div class="mr-4 h-2 w-96 overflow-hidden rounded-full bg-gray-300">
                  <div class="h-full w-1/12 bg-primary"></div>
                </div>
                <span class="w-3">4</span>
              </li>
              <li class="flex items-center text-sm font-medium">
          ...
          <button class="w-36 rounded-full bg-accent py-3 text-white font-medium">
            Write a review
          </button>
        </div>
      </div>
      <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column ">
        <p class="text-sm font-medium">
          I really love this stuff and would highly recommend to anyone. My skin
          is clear and feels amazing
        </p>
