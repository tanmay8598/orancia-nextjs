...
const Hero = () => {
  return (
    <div className="flex  px-5   items-center justify-center bg-hero md:h-screen overflow-hidden">
      <div className="flex flex-col  gap-6 md:flex-row items-center max-w-8xl">
        <div className="w-full md:w-1/2 lg:pr-32">
          <h2>Natural Makeup Infused with Precious Skincare Botanicals</h2>
          <h3 className="text-justify text-sm mt-6 md:mt-10 text-md  md:text-left text-gray-700 font-light tracking-wider leading-relaxed">
